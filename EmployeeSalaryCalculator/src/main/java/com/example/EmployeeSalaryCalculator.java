...
public class EmployeeSalaryCalculator 
{
	...
	static int salaryCalculator(int HW,int HR)
	{
		...
		*/
				...
				{
					//YOUR CODE STARTS HERE
					final int overTimeHours = hoursWorked - 40;
					final int regularTimeHours = hoursWorked - overTimeHours;
					grossSalary += (hourlyRate * 2) * overTimeHours;
					grossSalary += hourlyRate * regularTimeHours;
					//YOUR CODE ENDS HERE
				}
				return grossSalary;
	}
